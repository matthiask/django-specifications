...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpecificationField.type'
        db.alter_column('specifications_specificationfield', 'type', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        
        # Changing field 'SpecificationField.type'
        db.alter_column('specifications_specificationfield', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))
