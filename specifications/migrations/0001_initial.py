            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (b"text", "text"),
                            (b"longtext", "long text"),
                            (b"boolean", "boolean"),
                            (b"integer", "integer"),
                            (b"closed_set_single", "closed set"),
                            (b"closed_set_multiple", "closed set (multiple)"),
                            (b"open_set_single", "open set"),
                            (b"open_set_single_extensible", b"open set (extensible)"),
                        ],
                        verbose_name="type",
                        max_length=30,
                    ),
